...
public interface PatientListService extends OpenmrsService {
	/*
	    ...
	    public List<PatientList> getPatientListByName(String);

	    public PatientList getPatientListByUuid(String);

	    public List<PatientList> getPatientListByEncounterType(EncounterType);

	    public List<Patient> getPatientsInList(PatientList);
