 ...
 */
@Component
public class MRSPatientsCouchDBDAOImpl extends MotechBaseRepository<Patient> implements MRSPatientDAO
{

    @Autowired
    public MRSPatientsCouchDBDAOImpl(@Qualifier("patientMRSDatabase") CouchDbConnector db) {
