...
public abstract class BaseDelegatingResourceTest<R extends BaseDelegatingResource<T>, T>
	...
	public void validateRefRepresentation() throws Exception {
		...
		List<Hyperlink> links = (List<Hyperlink>) getRepresentation().get(
				"links");
		boolean self = false;
	...
	public R newResource() {
		ParameterizedType t = (ParameterizedType) getClass()
	...
	public SimpleObject newRefRepresentation() throws Exception {
		return (SimpleObject) getResource().asRepresentation(getObject(),
				Representation.REF);
	}
	 ...
	 */
	@Test
	public void asRepresentation_shouldReturnValidRefRepresentation()
			throws Exception {
	 ...
	 */
	@Test
	public void asRepresentation_shouldReturnValidDefaultRepresentation()
			throws Exception {
	 ...
	 */
	@Test
	public void asRepresentation_shouldReturnValidFullRepresentation()
			throws Exception {
