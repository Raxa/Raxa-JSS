describe("Bmi", function() {
    ...
    it("Verify that pressing submit button causes patient object to get updated BMI", function() { /*expect(false).toBeTruthy();*/
    });

    // Verify Rest calls are correctly formatted and return expected response
    it("Verify that pressing submit button makes (?) Rest Call", function() { /*expect(false).toBeTruthy();*/
    });
