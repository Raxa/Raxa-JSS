...
Ext.application({
    ...
    models: ['Patient', 'Doctor', 'Links', 'PostList', 'GetList', 'Patients', 'Encounters', 'Observation', 'druglist', 'drugOrder', 'drugEncounter'],
    ...
    stores: ['Patients', 'Doctors', 'PostLists', 'druglist', 'drugEncounter'],
