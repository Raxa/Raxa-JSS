...
var Util = {
    ...
    getLoggedInProviderUuid: function() {
        if (!localStorage.getItem("loggedInUser")) return "provider is not logged in";
        if (localStorage.getItem("loggedInProvider")) return localStorage.getItem("loggedInProvder");
        else return this.getProviderUuidFromPersonUuid(localStorage.getItem("loggedInUser"));
    },
