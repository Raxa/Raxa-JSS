...
if(localStorage.regUuidencountertype == undefined) { var regUuidEncountertype = Util.getAttributeFromREST('encountertype', 'reg','REGISTRATION - Encounter for Patient at Registration'); }
if(localStorage.adultreturnUuidencountertype == undefined) { var adultreturnUuidEncountertype = Util.getAttributeFromREST('encountertype', 'adultreturn','ADULTRETURN - Outpatient Adult Return Visit'); }