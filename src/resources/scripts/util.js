...
*/
     ...
     */
    sendAlert: function(name, description, providerSent, providerRecipient, toLocation, fromLocation, patient, alertType, defaultTask){
        if(providerSent==null){
            console.log('Requires providerSent');
            return;
        }
        var alert = {
        ...
        if(providerRecipient!==null)
            alert.providerRecipient = providerRecipient;
        if(toLocation!==null)
            alert.toLocation = toLocation;
        if(fromLocation!==null)
            alert.fromLocation = fromLocation;
        if(patient!==null)
            alert.patient = patient;
        if(alertType!==null)
            alert.alertType = alertType;
        if(defaultTask!==null)
            alert.defaultTask = defaultTask;
        var alertParam = Ext.encode(alert);
        Ext.Ajax.request({
