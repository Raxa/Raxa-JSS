    ...
    drawSeries: function() {
        ...
        store.each(function(record, i) {
            ...
            if (typeof xValue == 'string' || typeof xValue == 'object'
                ...
                || (Ext.Array.indexOf([].concat(me.axis), 'left') > -1 && chart.axes.get('left').type == 'Category'
                ||  Ext.Array.indexOf([].concat(me.axis), 'right') > -1 && chart.axes.get('right').type == 'Category')) {
                xValue = i;
            }
            ...
            if (typeof yValue == 'string' || typeof yValue == 'object'
                //set as uniform distribution if the axis is a category axis.
                || (Ext.Array.indexOf([].concat(me.axis), 'top') > -1 && chart.axes.get('top').type == 'Category'
                ||  Ext.Array.indexOf([].concat(me.axis), 'bottom') > -1 && chart.axes.get('bottom').type == 'Category')) {
                yValue = i;
            }
            xValues.push(xValue);
            yValues.push(yValue);
