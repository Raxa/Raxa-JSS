...
Ext.define('Ext.util.NewFilter', {
    ...
    config: {
        ...
        /**
         * @cfg {RegExp/Mixed} value The value you want to match against. Can be a regular expression which will
         * be used as matcher or any other value.
         */
        value: null,
        ...
        /**
         * @cfg {String} id An optional id this filter can be keyed by in Collections. If
         * no id is specified it will generate an id by first trying a combination of property-value,
         * and if none if these were specified (like when having a filterFn) it will generate a random id.
         */
        id: undefined,

        /**
         * @cfg {Object} scope The scope in which to run the filterFn
         */
        scope: null
    },
