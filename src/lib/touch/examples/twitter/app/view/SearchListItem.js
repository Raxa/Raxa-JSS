/**
 * @class Twitter.view.SearchListItem
 * @extends Ext.dataview.ListItem
 * 
 * This is a search list item for the SearchList view. It contains two items: one for the search query, and a Ext.Button which
