...
Ext.application({
    ...
    views: ['loginScreen', 'patientList', 'patientDetails', 'vcNotifications', 'vcScheduling','userToolbar','addOptions','addPatient','addReminder','addAppointment','notificationInbox','resources','resourceDetail','vcToolbar','okCancel'],
    launch: function () {
