    ...
    config: {
        ...
        items: [{
            ...
            items: [{
                ...
                itemTpl: ['<div style="float:left;width:32px;height:32px"><img src="{familyImage}" height="80%" width="80%"/></div>', '<div style="float:left;width:70%">', '<div class="list-item-title" style="font-size:15px;">{familyName}</div>', '<div class="list-item-narrative" style="font-size:11px;">{familyDescrip}</div>', '</div>'].join(''),
            ...
            items: [{
                ...
                centered: true,
                indexBar: true,
                itemTpl: ['<div style="float:left;width:32px;height:32px">', '<img src="{illnessImage}" height="80%" width="80%"/>', '</div>', '<div>&nbsp&nbsp{illnessName}</div>'].join(''),
